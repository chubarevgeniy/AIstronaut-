...
const STAR_FUEL_BURN_RATE = 20.0
const NEAR_MISS_SPEED_THRESHOLD = 300.0
const NEAR_MISS_FUEL_REWARD = 10.0
const NEAR_MISS_COOLDOWN = 1.0
const NEAR_MISS_DISTANCE = 40.0
const DEBUG_START_DISTANCE = 0.0
const LANDING_MAX_SPEED = 65.0
const DEBUG_SHOW_NEAR_MISS = 0
